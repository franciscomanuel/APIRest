...
<h2>Inserción de un nuevo empleado </h2>
...
<fieldset id='FldBotones' class='bloqueRedondeado'>
    <div id='DivBotones'>
        <button value='<?php echo $dep;?>' id='InpInsertar' class='procesaBotones'>Insertar</button>
        <!--<input type='submit' value='Insertar' id='InpInsertar' class='procesaBotones'>
        <input type='submit' value='Cancelar' id='InpCancelar' class='procesaBotones'>-->
    </div>
</fieldset>